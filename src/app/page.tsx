    ...
    <div className="min-h-screen bg-black text-white selection:bg-indigo-500/30">
      ...
      <main className="relative z-10 text-center">
        ...
        <section className="mx-auto max-w-4xl px-4 md:px-6 pt-16 md:pt-32 pb-12 md:pb-20 text-left md:text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight mb-6 md:mb-8 bg-gradient-to-b from-white to-zinc-400 bg-clip-text text-transparent pb-2">
            Master your web <br className="hidden md:block" />
            <span className="text-indigo-400">performance</span> metrics.
          </h1>

          <p className="text-base md:text-lg lg:text-xl text-zinc-400 mb-8 md:mb-10 max-w-2xl mx-auto leading-relaxed px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 px-4">
            <Link href="/signup" className="w-full sm:w-auto">
              <Button variant="premium" size="lg" className="w-full sm:w-auto h-11 md:h-12 px-6 md:px-8 text-sm md:text-base rounded-full shadow-[0_0_20px_rgba(99,102,241,0.5)] hover:shadow-[0_0_30px_rgba(99,102,241,0.6)] transition-shadow">
                Start Monitoring Free <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <Link href="https://performance-monitor-beta.vercel.app" target="_blank" className="w-full sm:w-auto">
              <Button variant="outline" size="lg" className="w-full sm:w-auto h-11 md:h-12 px-6 md:px-8 text-sm md:text-base rounded-full border-zinc-700 hover:bg-zinc-800">
                View Live Demo
              </Button>
            </Link>
          </div>
        ...
        <section className="mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <Card className="bg-zinc-900/40 border-zinc-800/60 backdrop-blur-sm group hover:bg-zinc-900/60 transition-colors">
              <CardHeader>
                <BarChart3 className="h-8 w-8 md:h-10 md:w-10 text-indigo-400 mb-4 group-hover:scale-110 transition-transform duration-300" />
                <CardTitle className="text-base md:text-lg">Historical Analytics</CardTitle>
            ...
            <Card className="bg-zinc-900/40 border-zinc-800/60 backdrop-blur-sm group hover:bg-zinc-900/60 transition-colors">
              <CardHeader>
                <Smartphone className="h-8 w-8 md:h-10 md:w-10 text-purple-400 mb-4 group-hover:scale-110 transition-transform duration-300" />
                <CardTitle className="text-base md:text-lg">Multi-Device Testing</CardTitle>
                <CardDescription className="text-sm">
            ...
            <Card className="bg-zinc-900/40 border-zinc-800/60 backdrop-blur-sm group hover:bg-zinc-900/60 transition-colors">
              <CardHeader>
                <Globe className="h-8 w-8 md:h-10 md:w-10 text-emerald-400 mb-4 group-hover:scale-110 transition-transform duration-300" />
                <CardTitle className="text-base md:text-lg">Global Standards</CardTitle>
                <CardDescription className="text-sm">
        ...
        {/* Tech Stack / Trust */}
        <section className="py-12 md:py-20 border-y border-zinc-800/50 bg-zinc-950/30">
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            <h2 className="text-xl md:text-2xl font-semibold mb-8 md:mb-12 text-zinc-300">Built with modern, robust technology</h2>
            <div className="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-16 opacity-70 grayscale transition-all hover:grayscale-0">
              <div className="flex items-center gap-2 text-base md:text-xl font-bold"><LayoutDashboard className="h-5 w-5 md:h-6 md:w-6" /> Next.js 14</div>
              <div className="flex items-center gap-2 text-base md:text-xl font-bold"><Lock className="h-5 w-5 md:h-6 md:w-6" /> Supabase Auth</div>
              <div className="flex items-center gap-2 text-base md:text-xl font-bold"><Zap className="h-5 w-5 md:h-6 md:w-6" /> Tailwind CSS</div>
              <div className="flex items-center gap-2 text-base md:text-xl font-bold"><Globe className="h-5 w-5 md:h-6 md:w-6" /> Vercel Edge</div>
            </div>
          </div>
        </section>
      </main>
