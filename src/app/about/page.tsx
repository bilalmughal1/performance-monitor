...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-black text-white selection:bg-indigo-500/30">
            ...
            <main className="relative z-10 mx-auto max-w-5xl px-6 py-20 space-y-20">
                {/* Hero Section */}
                ...
                {/* Future Vision */}
                <section className="space-y-6 bg-gradient-to-br from-indigo-950/20 to-purple-950/20 border border-indigo-500/20 rounded-2xl p-8">
                ...
                <section className="text-center space-y-6 py-12">
                    ...
                    <Link href="/signup">
                        <Button variant="premium" size="lg" className="h-12 px-8 text-base rounded-full shadow-[0_0_20px_rgba(99,102,241,0.5)]">
