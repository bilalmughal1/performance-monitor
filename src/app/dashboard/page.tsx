...
export default function DashboardPage() {
  ...
  return (
    <div className="px-4 md:px-6 lg:px-8 py-6 md:py-8 space-y-6 md:space-y-8 max-w-7xl mx-auto">
      {/* Header */}
              ...
              <Card className="h-full transition-all duration-300 hover:border-zinc-700 hover:bg-zinc-900/80">
                ...
                <CardContent>
                  <div className="grid grid-cols-3 gap-3 py-2 text-left">
                    <div className="p-2 rounded bg-zinc-950/60 space-y-1">
                      <div className="text-[11px] text-muted-foreground uppercase">LCP</div>
                      <div className="font-mono font-semibold text-sm leading-tight">
                        {latest && latest.lcp ? `${(latest.lcp / 1000).toFixed(1)}s` : "--"}
                      </div>
                    </div>
                    <div className="p-2 rounded bg-zinc-950/60 space-y-1">
                      <div className="text-[11px] text-muted-foreground uppercase">CLS</div>
                      <div className="font-mono font-semibold text-sm leading-tight">
                        {latest?.cls ?? "--"}
                      </div>
                    </div>
                    <div className="p-2 rounded bg-zinc-950/60 space-y-1">
                      <div className="text-[11px] text-muted-foreground uppercase">SEO</div>
                      <div className="font-mono font-semibold text-sm leading-tight">
                        {latest?.seo ?? "--"}
                      </div>
                    </div>
